...
<h1>TransDub Studio 软件许可与服务协议</h1>
<p>更新日期：2026年7月</p>

<p>欢迎使用 TransDub Studio（以下简称“本软件”）！本软件是基于 pyVideoTrans 修改的免费、开源本地视频翻译和语音转录工具。在安装、复制或以任何方式使用本软件前，请您务必仔细阅读并充分理解本协议中的所有条款。</p>

<p class="warning"><strong>您的安装、复制、下载或任何形式的使用行为，即表示您已阅读、理解并无条件接受本协议所有条款的约束。如果您不同意本协议的任何内容，请立即停止使用并从您的设备中彻底删除本软件。</strong></p>

<h2>1. 许可授予与软件性质</h2>
<ul>
    <li><strong>开源免费</strong>：本软件是一款基于 GPL-v3 开源协议发布的免费软件。本软件基于 pyVideoTrans（<code>https://github.com/jianchang512/pyvideotrans</code>）修改而来，并继续遵循 GPL-v3 协议发布。TransDub Studio 不是 pyVideoTrans 官方版本。</li>
...
"""
        ...
        lawalert.setWindowTitle('TransDub Studio '+tr('Software License Agreement'))
